...
// Setup collaborative notes ShareDB
var ShareDB = require('sharedb');
var mongodb = require('mongodb');
var richText = require('rich-text');
ShareDB.types.register(richText.type);

var dbName = 'mongodb://' + Config.DB_HOST + '/' + Config.DB_NAME
var db = require('sharedb-mongo')(dbName);
console.log("Connecting to DB...");
GLOBAL.SharedDB = new ShareDB({db: db});
...
app.use(session({
  secret: Config.SECRET,
  store: new RedisStore({host: Config.CACHE_HOST, port: Config.CACHE_PORT, client: client}),
  saveUninitialized: true,
  resave: false
}));
