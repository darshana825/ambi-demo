...
var PriorityTag = function (_Component) {
    _inherits(PriorityTag, _Component);

    function PriorityTag() {
        _classCallCheck(this, PriorityTag);

        return _possibleConstructorReturn(this, (PriorityTag.__proto__ || Object.getPrototypeOf(PriorityTag)).apply(this, arguments));
    }

    _createClass(PriorityTag, [{
        key: 'render',
        value: function render() {
            ...
            var combinedClassName = (0, _unionClassNames2.default)(theme.prioritytag, className);
